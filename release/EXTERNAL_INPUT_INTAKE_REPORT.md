...
| `github_token_rotation_confirmed` | `P0` | `pass` | `no` | value=yes | Enter yes/approved/confirmed, or document corrections before approval. |
| `zenodo_doi` | `P0` | `pass` | `no` | doi_valid=True; zenodo_token_file_present=True | Fill a real DOI or save a Zenodo token outside the repository. |
