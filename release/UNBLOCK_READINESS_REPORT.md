...
| `live_gantt_blockers` | `blocking_rows=3` | `yes` | manuscript/SHEAFSIGNAL_LIVE_GANTT_STATUS.md | Resolve release-chain blockers shown in the live Gantt: GitHub branch/tag, DOI, metadata insertion, clean-clone, and submission-day journal check. |
