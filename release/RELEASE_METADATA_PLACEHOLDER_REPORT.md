...
- `CITATION.cff:9` [github_url_pending] repository-code: "https://github.com/TBD/SheafSignal"
- `pyproject.toml:50` [github_url_pending] Homepage = "https://github.com/TBD/SheafSignal"
- `pyproject.toml:51` [github_url_pending] Repository = "https://github.com/TBD/SheafSignal"
- `pyproject.toml:52` [github_url_pending] Issues = "https://github.com/TBD/SheafSignal/issues"
...
- `release/zenodo_deposition_metadata.json:21` [github_url_pending] "identifier": "https://github.com/TBD/SheafSignal",
...
- `CITATION.cff:7` [software_author_metadata_pending] - family-names: "TBD"
- `CITATION.cff:8` [software_author_metadata_pending] given-names: "TBD"
- `.zenodo.json:7` [software_author_metadata_pending] "name": "TBD"
- `release/zenodo_deposition_metadata.json:7` [software_author_metadata_pending] "name": "TBD"
- `manuscript/NATURE_METHODS_GO_NO_GO_REPORT.md:19` [author_owned_submission_metadata] - `author_metadata::competing_interests`: tbd_by_authors. Action: Replace TBD with final competing interests statement.
- `manuscript/submission_metadata/AUTHOR_METADATA_TEMPLATE.tsv:2` [author_owned_submission_metadata] 1	TBD	TBD	TBD	TBD	A1	TBD	Conceptualization; Methodology; Software; Formal analysis; Writing - original draft	TBD	tbd_by_authors
- `manuscript/submission_metadata/AFFILIATIONS_TEMPLATE.tsv:2` [author_owned_submission_metadata] A1	TBD	TBD	TBD	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:2` [author_owned_submission_metadata] Conceptualization	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:3` [author_owned_submission_metadata] Methodology	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:4` [author_owned_submission_metadata] Software	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:5` [author_owned_submission_metadata] Formal analysis	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:6` [author_owned_submission_metadata] Investigation	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:7` [author_owned_submission_metadata] Data curation	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:8` [author_owned_submission_metadata] Writing - original draft	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:9` [author_owned_submission_metadata] Writing - review and editing	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:10` [author_owned_submission_metadata] Supervision	TBD	tbd_by_authors
- `manuscript/submission_metadata/AUTHOR_CONTRIBUTIONS_CREDIT_TEMPLATE.tsv:11` [author_owned_submission_metadata] Funding acquisition	TBD	tbd_by_authors
- `manuscript/submission_metadata/COMPETING_INTERESTS_TEMPLATE.md:3` [author_owned_submission_metadata] TBD.
- `manuscript/submission_metadata/ETHICS_AND_DATA_USE_STATEMENT.md:11` [author_owned_submission_metadata] TBD by authors before submission: confirm whether the manuscript requires an
- `manuscript/submission_metadata/SUBMISSION_SYSTEM_METADATA_CHECKLIST.tsv:6` [author_owned_submission_metadata] competing_interests	authors	tbd_by_authors	Replace TBD in COMPETING_INTERESTS_TEMPLATE.md.

## Interpretation Boundary

This audit does not fill author names, affiliations, competing interests, public repository URLs, or Zenodo DOI values. It separates these pending items from code/scientific blockers so the release can be frozen only after the required external identifiers and author metadata are real.
