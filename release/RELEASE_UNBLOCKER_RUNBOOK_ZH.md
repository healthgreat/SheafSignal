...
- `G07_author_confirmation`: `packet_ready_author_confirmation_pending` -> Confirm corresponding author email, CRediT, funding, COI, ethics/data-use, and release approval.
