...
| `user_action_now_packet` | `USER_ACTION_PACKET_READY_P0_BLOCKERS_REMAIN` | `user_then_codex` | `yes` | Clear the P0 rows in release/USER_ACTION_NOW_PACKET.tsv. |
| `external_input_intake` | `EXTERNAL_INPUT_INTAKE_P0_MISSING` | `user_then_codex` | `yes` | Fill missing P0 rows in release/EXTERNAL_INPUT_INTAKE_TEMPLATE.tsv. |
